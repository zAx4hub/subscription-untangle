# Subscription Untangle

> Untangle overlapping SaaS subscriptions

**Author:** zAx4hub

## Problem

Untangle overlapping SaaS subscriptions. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`subscription-untangle` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **trace** engine, CLI, examples, and tests.
